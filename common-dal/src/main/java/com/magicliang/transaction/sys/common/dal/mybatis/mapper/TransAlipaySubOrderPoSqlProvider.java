...
import com.magicliang.transaction.sys.common.dal.mybatis.po.TransAlipaySubOrderPoExample.Criteria;
import com.magicliang.transaction.sys.common.dal.mybatis.po.TransAlipaySubOrderPoExample.Criterion;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class TransAlipaySubOrderPoSqlProvider {
     ...
     */
    public String countByExample(TransAlipaySubOrderPoExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("tb_trans_alipay_suborder");
     ...
     * @mbg.generated Wed Jan 26 17:49:11 CST 2022
     */
    public String deleteByExample(TransAlipaySubOrderPoExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("tb_trans_alipay_suborder");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Wed Jan 26 17:49:11 CST 2022
     */
    public String insertSelective(TransAlipaySubOrderPo record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("tb_trans_alipay_suborder");
        ...
        if (record.getToAccountNo() != null) {
            sql.VALUES("to_account_no", "#{toAccountNo,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated Wed Jan 26 17:49:11 CST 2022
     */
    public String selectByExample(TransAlipaySubOrderPoExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("to_account_no");
        sql.SELECT("name");
        sql.FROM("tb_trans_alipay_suborder");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TransAlipaySubOrderPo record = (TransAlipaySubOrderPo) parameter.get("record");
        TransAlipaySubOrderPoExample example = (TransAlipaySubOrderPoExample) parameter.get("example");

        SQL sql = new SQL();
        sql.UPDATE("tb_trans_alipay_suborder");
        ...
        if (record.getToAccountNo() != null) {
            sql.SET("to_account_no = #{record.toAccountNo,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated Wed Jan 26 17:49:11 CST 2022
     */
    public String updateByPrimaryKeySelective(TransAlipaySubOrderPo record) {
        SQL sql = new SQL();
        sql.UPDATE("tb_trans_alipay_suborder");
        ...
        if (record.getToAccountNo() != null) {
            sql.SET("to_account_no = #{toAccountNo,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated Wed Jan 26 17:49:11 CST 2022
     */
    protected void applyWhere(SQL sql, TransAlipaySubOrderPoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
