...
public interface TransBankCardSubOrderPoMapper {
    ...
    int updateByExampleSelective(@Param("record") TransBankCardSubOrderPo record,
            @Param("example") TransBankCardSubOrderPoExample example);
    ...
    int updateByExample(@Param("record") TransBankCardSubOrderPo record,
            @Param("example") TransBankCardSubOrderPoExample example);
