...
public interface TransChannelRequestPoMapper {
    ...
    int updateByExampleSelective(@Param("record") TransChannelRequestPoWithBLOBs record,
            @Param("example") TransChannelRequestPoExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") TransChannelRequestPoWithBLOBs record,
            @Param("example") TransChannelRequestPoExample example);
    ...
    int updateByExample(@Param("record") TransChannelRequestPo record,
            @Param("example") TransChannelRequestPoExample example);
