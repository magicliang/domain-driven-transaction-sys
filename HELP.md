...
* The original package name 'com.magicliang.domain-driven-transaction-sys' is invalid and this project uses '
  com.magicliang.domaindriventransactionsys' instead.
